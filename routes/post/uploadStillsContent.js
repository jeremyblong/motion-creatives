            ...
            if (user) {
                ...
                promise.then((pictures) => {
                    ...
                    if (user.stills_content) {
                        user.stills_content = _.union(user.stills_content, pictures);
                    } else {
                        user["stills_content"] = pictures;
                    }

                    collection.save(user);

                    res.json({
                        message: "Successfully updated your photos to the STILL's page!",
                        pictures: user.stills_content
                    })
                })
            } else {
                res.json({

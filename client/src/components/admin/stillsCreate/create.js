...
class StillsCreateHelper extends Component {
constructor(props) {
    super(props);
    ...
    handleSubmission = (e) => {
        ...
        axios.post("/upload/stills/content", {
            pictures,
            email: this.props.email 
        }).then((res) => {
            if (res.data.message === "Successfully updated your photos to the STILL's page!") {
                console.log(res.data);

                this.setState({
                    selected: false
                }, () => {
                    NotificationManager.success("Successfully added your new photos to the STILL's page!", 'SUCCESS!', 5000);
                })
            } else {
    ...
    render() {
        ...
        return (
            <div className="main">
                ...
                <div className="container custom-contain-three">
                    <div className="row justify-content-center inner-content">
                        <div className="col-12 col-lg-10 col-xl-8 mx-auto">
                        <h2 style={{ paddingTop: "50px" }} className="h3 mb-4 page-title">STILL's - Create Content</h2>
                        <div className="my-4">
                            ...
                            <form autocomplete="off">
                                <div className="row mt-5 align-items-center">
                                    ...
                                    <div className="row mb-4">
                                        <div className="col-md-12 col-sm-12">
                                        <p className="lead">
                                            You can choose JPG's, PNG's, or JPEG's for the uploads on the STILL's content page. Tall images will fit appropriately similarily to the smaller horizontal pictures.
                                        </p>
                                        </div>
                                        <div className="col">
...
export default withRouter(connect(mapStateToProps, { })(StillsCreateHelper));